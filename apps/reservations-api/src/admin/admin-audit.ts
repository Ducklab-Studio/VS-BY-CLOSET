...
const CRITICAL_ACTIONS = new Set([
  ...
  'UNIT_DEACTIVATED',
  'UNIT_UPDATED',
  'CATALOG_UNIT_DEACTIVATED',
  'CATALOG_UNIT_REACTIVATED',
  'BLOCK_CREATED',
  'BLOCK_UPDATED',
  'BLOCK_ACTIVATED',
  'BLOCK_DEACTIVATED',
  ...
  'SUPER_ADMIN_REMOVED',
  'ADMIN_SEED_APPLIED',
  'VALE_PASS_CAMPAIGN_CREATED',
  'VALE_PASS_CAMPAIGN_ACTIVATED',
  'VALE_PASS_CAMPAIGN_DEACTIVATED',
  'VALE_PASS_CANCELLED_BY_ADMIN',
  'VALE_PASS_RESTORED',
  'VALE_PASS_RESTORE_BLOCKED',
]);
